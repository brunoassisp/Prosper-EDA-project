...
```{r warning=FALSE, message=FALSE, echo=FALSE, loan_status}
ggplot(data = ld
       ,aes(x = LoanStatus)) +
...
### Analysing how the Listings are distributed across the Risk Ratings and their
rates.
```{r echo=FALSE, warning=FALSE, message=FALSE, listings}
ggplot(data = ld
...
If we look to the **Estimated Effective Yield** distribution according to the 
